...
$m = new Member();
$categories = $m->getAllCategories("faldoni_categories");
?>
...
<html>
    ...
    <script type="text/javascript" src="js/insert_faldoni.js"></script>
	...
	<div id="content">
	    <div class="tab">
  		<div class="testo" align="center"><h2>Faldoni</h2></div>
		...
		<br>
		<div align="center">
		    <form class="form_sel_faldoni" id="form_sel_faldoni" name="form_sel_faldoni" action method="post">
			<label>Scegli documento:</label>
			<select id="sel_faldoni" name="sel_faldoni">
			</select>
		    </form>
		</div>
		<br>
		...
		<br><br>
		<div align="center">
		    <form class="delete_ebook" name="delete_faldoni" id="delete_faldoni" action method="POST">
			<div id="search_results_for_delete"></div>
			<button type="submit" id="submit_delete"><img src="/view/icons/trash.png">&nbsp;Rimuovi documenti selezionati</button>
		    </form>
		</div>
