...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/insert_delibera.js"></script>
    </head>
    <body>
        ...
        <div id="content">
            <div class="tab">
  	            <div class="testo" align="center"><h2>Delibere</h2></div>
            ...
            <div id="Update" class="tabcontent">
                ...
                <br>
                <div align="center">
                    <form class="form_sel_delibera" id="form_sel_delibera" name="form_sel_delibera" action method="post">
                        <label for="delibera">Scegli delibera:</label>
                        <select id="delibera" name="delibera"> 
                        </select>        
                    </form> 
                </div>
                <br>
            ...
            <div id="Delete" class="tabcontent">
                ...
                <br><br>
                <div align="center">
                    <form class="delete_delibera" name="delete_delibera" id="delete_delibera" action method="POST">
                        <div id="search_results_for_delete"></div>                   
                        <button type="submit" id="submit_delete"><img src="/view/icons/trash.png">&nbsp;Rimuovi Delibere Selezionate</button>
                    </form>
                </div>
